...
from get_validations import get_validation_map
...
from excel_utils.excel_adjacent_cell_utils import find_labels_of_given_empty_green_cell_to_be_filled
from excel_utils.excel_color_utils import get_colored_cells
...
if __name__ == "__main__":
    ...
    for green_cell in green_cells:
        ...
        # if green_cell.coordinate == 'F18':
            # border = find_labels_of_given_empty_green_cell_to_be_filled(green_cell, sheet, max_parsing_times)
    ...
    combined_prompt = combine_multiple_rows_in_single_prompt(prompt, number_of_rows_in_a_prompt=10)
